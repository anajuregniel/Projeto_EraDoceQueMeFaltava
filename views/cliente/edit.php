                ...
                <div class="my-4">
                    ...
                    <form action="update.php" method="post">
                        <p class="form-group">
                            ...
                            <input type="text" name="nomeCliente" class="form-control" value="<?= $cliente->getNome() ?>">
                        </p>
                        <p class="form-group">
                            <label for="telefone">Telefone</label>
                            <input type="text" name="telefone" class="form-control" value="<?= $cliente->getNome() ?>">
                        </p>
                        <p class="form-group">
                            <label for="email">E-mail</label>
                            <input type="text" name="email" class="form-control" value="<?= $cliente->getNome() ?>">
                        </p>
